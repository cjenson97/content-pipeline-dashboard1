...
if mode == "Single Period":
    ...
    tbl += make_tbl_header([("Error Type", "left"), ("Count", "right"), ("Share", "right"), ("Description and Action", "left")])
    tbl += '<tbody>'
    ...
    if top5:
        ...
        t5 += make_tbl_header([("Rank", "left"), ("Source Domain", "left"), ("Failures", "right"), ("Relative Volume", "left")])
        t5 += '<tbody>'
        ...
        st.markdown('<p style="font-size:11px;color:' + TEXT_MUTED + ';margin-top:8px;">' + str(total_failures) + ' total failed articles across ' + str(unique_sources) + ' unique sources</p>', unsafe_allow_html=True)
    else:
    ...
    summary = (
        ...
        + "PDF Timeouts " + pdf_trend + " (" + fmt_diff(pdf_diff, pdf_cls) + ") &nbsp;·&nbsp; CAPTCHA errors " + cap_trend + " (" + fmt_diff(cap_diff, cap_cls) + ").<br><br>"
        + footer_note
        + "</div>"
    )
